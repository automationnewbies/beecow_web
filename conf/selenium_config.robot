...
${SERVER_URL}     https://beecow.mediastep.ca    # If ${METHOD_TEST}==Grid, change ${SERVER_URL} values with IP of test machine; Ex: http://192.168.33.10    # IP test sever linux vagrant
